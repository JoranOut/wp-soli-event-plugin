...
function soli_events_add_admin_view_page() {
  ...
  add_submenu_page(
    ...
    // publish_posts rather than manage_options: authors and editors publish
    // events and need the calendar. publish_posts rather than edit_posts so
    // contributors, who may draft but not publish, stay out along with
    // subscribers.
    'publish_posts',                // Capability required to access
