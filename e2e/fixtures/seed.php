 ...
 *
 * Also ensures role users exist: viz_subscriber / viz_editor / viz_author / viz_contributor
 * (password "password").
 *
...
/* ---- 4. Role users -------------------------------------------------- */
foreach ( array( 'viz_subscriber' => 'subscriber', 'viz_editor' => 'editor', 'viz_author' => 'author', 'viz_contributor' => 'contributor' ) as $login => $role ) {
